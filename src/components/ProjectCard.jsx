    ...
    <div className="p-5 sm:p-6 flex flex-col flex-1">
      ...
      <div className="mt-auto pt-2 flex gap-3">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex-1 flex items-center justify-center gap-2 py-2 bg-white text-black text-xs sm:text-sm font-bold uppercase tracking-wider rounded-full hover:bg-primary-glow hover:text-white transition-all duration-300 group/btn"
        >
          <span>Live Demo</span>
          <svg
            viewBox="0 0 24 24"
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex-1 flex items-center justify-center gap-2 py-2 bg-white/5 border border-white/10 text-white text-xs sm:text-sm font-bold uppercase tracking-wider rounded-full hover:bg-white/10 transition-all duration-300"
        >
